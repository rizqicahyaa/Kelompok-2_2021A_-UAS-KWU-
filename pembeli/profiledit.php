        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 mb-5 mb-lg-0">
                    <form class="form-contact contact_form" method="POST" action="profiledit_proses.php" enctype="multipart/form-data">
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    ...
                                    <div class="blog_item_date">
                                        <img src="<?= $data['pembeli_foto']; ?>" id="fotoprofil" alt="Foto Profil" class="img-fluid" style="border-radius: 100%; width: 150px; height: 150px;">
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-10">
                                            <div class="row">
                                                <div class="col-sm-12 mt-10 mb-10">
                                                    ...
                                                    <input type="text" required class="single-input" id="nama" name="nama" placeholder="Masukkan Nama Lengkap" value="<?= $data['pembeli_nama']; ?>">
                                                </div>
                                                <div class="col-12 mt-10 mb-10">
                                                    <label>
                                                        <h2>Username</h2>
                                                    </label>
                                                    <input type="text" required class="single-input" id="user" name="user" placeholder="Masukkan Username" value="<?= $data['pembeli_username']; ?>">
                                                </div>
                                                <div class="col-12 mt-10 mb-10">
                                                    <label>
                                                        <h2>Email</h2>
                                                    </label>
                                                    <input type="text" required class="single-input" id="email" name="email" placeholder="Masukkan Email" value="<?= $data['pembeli_email']; ?>">
                                                </div>
                                                <div class="col-12 mt-10 mb-10">
                                                    <label>
                                                        <h2>No.Hp</h2>
                                                    </label>
                                                    <input type="text" required class="single-input" id="nohp" name="nohp" placeholder="Masukkan No.Hp" value="<?= $data['pembeli_hp']; ?>">
                                                </div>
                                                <div class="col-12 mt-10 mb-10">
                                                    <label>
                                                        <h2>Jenis Kelamin</h2>
                                                ...
                                                <div class="col-12 mt-10 mb-10">
                                                    ...
                                                    <textarea class="single-textarea" id="alamat" name="alamat" placeholder="Masukkan Alamat"><?= $data['pembeli_alamat']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
