                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li class="active" style="background-color: #E7DAD4;" style=" color: #000000;"><a title="Data Produk" href="dataproduk.php"><span class="mini-sub-pro" style=" color: #000000;">Data Produk</span></a></li>
                            </ul>
                        </li>
                        ...
                        <div class="product-status-wrap" style="margin-top: 30px;">
                            <div class="row">
                                ...
                                <div class="breadcomb-report">
                                    <a href="laporan/laporandataproduk.php?toko_id=<?= $hasil['toko_id'] ?>"><button data-toggle="tooltip" title="Download Report" class="btn" style="color: white;"><i class="icon nalika-download"></i> Unduh Pdf</button></a>
                                    <a href="dataproduk_tambah.php"><button data-toggle="tooltip" title="Tambah Produk" class="btn" style="color: white;"><i class="fa fa-solid fa-plus"></i> Tambah</button></a>
                                </div>
                                <table>
                                    <tr>
                                        <th>No</th>
                                    ...
                                    <tr>
                                        <?php
                                        $que = $kon->kueri("SELECT * FROM toko a JOIN produk b ON a.toko_id = b.toko_id WHERE a.toko_id = '$idtoko' ");
                                        $no = 1;
                                        ...
                                        if ($jumlah == 0) {
                                            ...
                                            while ($data = $kon->hasil_data($que)) {
                                                echo "<tr>";
                                                echo "<td>$no</td>";
                                                echo "<td><img src='$data[produk_gambartumbnail]' style='width: 170px; height: 150px;'></td>";
                                                echo "<td>$data[produk_nama]</td>";
                                                if($data['produk_status'] == 'Ada') {
                                                    echo "<td><button class='pd-setting'\">Ada</button></td>";
                                                  }else{
                                                    echo "<td><button class='ds-setting'\">Habis</button></td>";
                                                  }
                                                echo "<td> $data[produk_stok]</td>";
                                                echo "<td>Rp. $data[produk_harga]</td>";
                                                echo "<td><a href='dataproduk_detail.php?id=$data[produk_id]'><button data-toggle='tooltip' title='Detail' class='pd-setting-ed'><i class='fa fa-light fa-eye'></i></button></a>
                                                        <a href='dataproduk_edit.php?id=$data[produk_id]'><button data-toggle='tooltip' title='Edit' class='pt-setting'><i class='fa fa-pencil-square-o' aria-hidden='true'></i></button></a>
                                                        <a href='#' onclick=\"javascript: if(confirm('Apakah produk dengan nama " . addslashes($data['produk_nama']) . " mau dihapus?')==true)
                                                        {window.location.href='dataproduk_proses.php?aksi=hapus&tid=$data[produk_id]'; } \"><button data-toggle='tooltip' title='Hapus' class='ds-setting'><i class='fa fa-trash-o' aria-hidden='true'></i></button></a>
                                                      </td>";
                                                echo "</tr>";
                                                $no++;
                                            }
