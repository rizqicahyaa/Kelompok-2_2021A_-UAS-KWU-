                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="breadcomb-wp">
                                        ...
                                        <div class="breadcomb-ctn">
                                            <h2>Tambah Produk</h2>
                                            <p>Silahkan Isi Form Tambah Produk</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                        <div class="input-group mg-b-pro-edt ts-forms">
                                                                            <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i> Nama Produk</span>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                        ...
                                                                        <div class="input-group mg-b-pro-edt ts-forms" style="margin-bottom: 25px;">
                                                                            ...
                                                                            <textarea class="form-control" id="detail" name="detail" placeholder="Detail Produk" style="height: 75px;"></textarea>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                        <div class="mg-b-pro-edt file-upload-inner ts-forms">
                                                                            <div class="input prepend-small-btn">
                                                                                ...
                                                                                <input type="text" id="tumbnail" placeholder="Tidak Ada File" disabled>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                        <div class="mg-b-pro-edt file-upload-inner ts-forms">
                                                                            <div class="input prepend-small-btn">
                                                                                ...
                                                                                <input type="text" id="produk1" placeholder="Tidak Ada File" disabled>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                        <div class="mg-b-pro-edt file-upload-inner ts-forms">
                                                                            <div class="input prepend-small-btn">
                                                                                ...
                                                                                <input type="text" id="produk2" placeholder="Tidak Ada File" disabled>
                                                                            </div>
                                                                        </div>
                                                                    </div>
