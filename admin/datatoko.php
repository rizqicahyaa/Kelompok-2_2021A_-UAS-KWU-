                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li class="active" style="background-color: #E7DAD4;" style=" color: #000000;"><a title="Data Toko" href="datatoko.php"><span class="mini-sub-pro" style=" color: #000000;">Data Toko</span></a></li>
                        ...
                        <div class="product-status-wrap" style="margin-top: 30px;">
                            <div class="row">
                                ...
                                <div class="breadcomb-report">
                                    <a href="laporan/laporandatatoko.php"><button data-toggle="tooltip" title="Download Report" class="btn" style="color: white;"><i class="icon nalika-download"></i> Unduh Pdf</button></a>
                                </div>
                                <table>
                                    <tr>
                                        <th>No</th>
                                    ...
                                    <tr>
                                        <?php
                                        $que = $kon->kueri("SELECT * FROM toko");
                                        $no = 1;
                                        ...
                                        if ($jumlah == 0) {
                                            ...
                                            while ($data = $kon->hasil_data($que)) {
                                                echo "<tr>";
                                                echo "<td>$no</td>";
                                                echo "<td>$data[toko_pemilik]</td>";
                                                echo "<td>$data[toko_nama]</td>";
                                                echo "<td>$data[toko_email]</td>";
                                                echo "<td>$data[toko_hp]</td>";
                                                echo "<td><a href='datatoko_detail.php?id=$data[toko_id]'><button data-toggle='tooltip' title='Detail' class='pd-setting-ed'><i class='fa fa-light fa-eye'></i></button></a>
                                                            <a href='datatoko_edit.php?id=$data[toko_id]'><button data-toggle='tooltip' title='Edit' class='pt-setting'><i class='fa fa-pencil-square-o' aria-hidden='true'></i></button></a>
                                                            <a href='#' onclick=\"javascript: if(confirm('Apakah toko dengan nama " . addslashes($data['toko_nama']) . " mau dihapus?')==true)
                                                            {window.location.href='datatoko_proses.php?aksi=hapus&tid=$data[toko_id]'; } \"><button data-toggle='tooltip' title='Hapus' class='ds-setting'><i class='fa fa-trash-o' aria-hidden='true'></i></button></a>
                                                        </td>";
                                                echo "</tr>";
                                                $no++;
                                            }
