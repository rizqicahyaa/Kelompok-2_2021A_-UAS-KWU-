...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.3.0/font-awesome.min.css">
    <!-- nalika Icon CSS
		============================================ -->
                                ...
                                <div class="sparkline12-list">
                                    <div class="sparkline12-graph">
                                        <div class="basic-login-form-ad">
                                            <div class="row">
                                                <?php
                                                $abc = $kon->kueri("SELECT * FROM produk a JOIN toko b ON a.toko_id = b.toko_id WHERE a.produk_id = '$produk' ");
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                        ...
                                                                        <div class="input-group mg-b-pro-edt ts-forms" style="margin-bottom: 25px;">
                                                                            ...
                                                                            <textarea class="form-control" id="detail" name="detail" placeholder="Detail Produk"><?php echo $data['produk_detail']; ?></textarea>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <div class="col-lg-4">
                                                                            <div class="pro-edt-img" style="border: 1px solid #cccccc; max-width: 100%; width: 220px; height: 200px; display: flex; align-items: center; justify-content: center;">
                                                                                <img src="../penjual/<?php echo $data['produk_gambartumbnail']; ?>" alt="" style="width: 170px; height: 150px;" id="fototumbnail" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-8">
                                                                            <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <div class="col-lg-4">
                                                                            <div class="pro-edt-img" style="border: 1px solid #cccccc; max-width: 100%; width: 220px; height: 200px; display: flex; align-items: center; justify-content: center;">
                                                                                <img src="../penjual/<?php echo $data['produk_gambar1']; ?>" alt="" style="width: 170px; height: 150px;" id="fotoproduk1" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-8">
                                                                            <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <div class="col-lg-4">
                                                                            <div class="pro-edt-img" style="border: 1px solid #cccccc; max-width: 100%; width: 220px; height: 200px; display: flex; align-items: center; justify-content: center;">
                                                                                <img src="../penjual/<?php echo $data['produk_gambar2']; ?>" alt="" style="width: 170px; height: 150px;" id="fotoproduk2" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-8">
                                                                            <div class="row">
