                                        ...
                                        if ($jumlah == 0) {
                                            ...
                                            while ($data = $que->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                echo "<td><a href='datapesanan_detail.php?id=$data[transaksi_id]'><button data-toggle='tooltip' title='Detail' class='pd-setting-ed'><i class='fa fa-light fa-eye'></i></button></a>
                                                        ...
                                                        {window.location.href='datapesanan_proses.php?aksi=hapus&tid=$data[transaksi_id]'; } \"><button data-toggle='tooltip' title='Hapus' class='ds-setting'><i class='fa fa-trash-o' aria-hidden='true'></i></button></a>
                                                      </td>";
                                                echo "</tr>";
                                                $no++;
                                            }
