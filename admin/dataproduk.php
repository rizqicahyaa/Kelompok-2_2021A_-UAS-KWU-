                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li  class="active" style="background-color: #E7DAD4;">
                            <a class="has-arrow" href="#" aria-expanded="false"><i class="icon nalika-folder icon-wrap" style=" color: #000000;"></i> <span class="mini-click-non"style=" color: #000000;">Data</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li class="active" style="background-color: #E7DAD4;"><a title="Data Produk" href="dataproduk.php"><span class="mini-sub-pro" style=" color: #000000;">Data Produk</span></a></li>
                        ...
                        <div class="product-status-wrap" style="margin-top: 30px;">
                            <div class="row">
                                ...
                                <div class="breadcomb-report">
                                    <a href="laporan/laporandataproduk.php"><button data-toggle="tooltip" title="Download Report" class="btn" style="color: white;"><i class="icon nalika-download"></i> Unduh Pdf</button></a>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <?php
                                        $que = $kon->kueri("SELECT * FROM produk");
                                        $no = 1;
                                        ...
                                        if ($jumlah == 0) {
                                            ...
                                            while ($data = $kon->hasil_data($que)) {
                                                echo "<tr>";
                                                echo "<td>$no</td>";
                                                echo "<td><img src='../penjual/$data[produk_gambartumbnail]' style='width: 170px; height: 150px;'></td>";
