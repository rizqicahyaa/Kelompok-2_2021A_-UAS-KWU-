                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li class="active" style="background-color: #E7DAD4;"><a title="Data Toko" href="datatoko.php"><span class="mini-sub-pro" style=" color: #000000;">Data Toko</span></a></li>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="breadcomb-wp">
                                        ...
                                        <div class="breadcomb-ctn">
                                            ...
                                            <p>Silahkan Isi Form Edit Toko</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <div class="col-lg-4">
                                                                            <div class="pro-edt-img" style="border: 1px solid #cccccc; max-width: 100%; width: 220px; height: 200px; display: flex; align-items: center; justify-content: center;">
                                                                                <img src="../penjual/<?php echo $data['toko_foto']; ?>" alt="" style="width: 170px; height: 150px;" id="fototoko" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-8">
                                                                            <div class="row">
                                                                                            ...
                                                                                            <div class="input-group">
                                                                                                ...
                                                                                                <div class="input append-small-btn">
                                                                                                    <div class="file-button">
                                                                                                        Upload
                                                                                                        <input type="file" id="fototoko" name="fotopembeli" onchange="document.getElementById('toko').value = this.value;">
                                                                                                    </div>
                                                                                                </div>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                        <div class="input-group mg-b-pro-edt ts-forms">
                                                                            ...
                                                                            <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama Pemilik Toko" value="<?php echo $data['toko_pemilik']; ?>">
                                                                        </div>
                                                                        <div class="input-group mg-b-pro-edt ts-forms">
                                                                            <span class="input-group-addon"><i class="icon nalika-diamond" aria-hidden="true"></i></span>
                                                                            <input type="text" id="toko" name="toko" class="form-control" placeholder="Nama Toko" value="<?php echo $data['toko_nama']; ?>">
                                                                        </div>
                                                                        <div class="input-group mg-b-pro-edt ts-forms">
                                                                            <span class="input-group-addon"><i class="fa fa-phone" aria-hidden="true"></i></span>
                                                                            <input type="text" id="telp" name="telp" class="form-control" placeholder="No.Telp Toko" value="<?php echo $data['toko_hp']; ?>">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                        ...
                                                                        <div class="input-group mg-b-pro-edt ts-forms">
                                                                            ...
                                                                            <input type="text" id="email" name="email" class="form-control" placeholder="Email User" value="<?php echo $data['toko_email']; ?>">
                                                                        </div>
                                                                        <div class="input-group mg-b-pro-edt ts-forms">
                                                                            <span class="input-group-addon"><i class="icon nalika-favorites-button" aria-hidden="true"></i></span>
                                                                            <textarea class="form-control" id="alamat" name="alamat" placeholder="Alamat User"><?php echo $data['toko_alamat']; ?></textarea>
                                                                        </div>
                                                                    </div>
