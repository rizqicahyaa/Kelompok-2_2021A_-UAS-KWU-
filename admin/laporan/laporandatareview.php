...
$xyz = $kon->kueri("SELECT a.review_id, a.review_isi, a.review_rating, b.pembeli_nama, c.produk_nama, d.toko_nama FROM review a JOIN pembeli b ON (a.pembeli_id = b.pembeli_id) JOIN produk c ON (a.produk_id = c.produk_id) JOIN toko d ON (a.toko_id = d.toko_id) LIMIT 0,10 ");
$no = 1;
$grandtotal = 0;
...
while ($hasil = $kon->hasil_data($xyz)) {
	...
	$abc->Cell(10, 5, $hasil['review_id'], 1, 0, 'L', $fill);
