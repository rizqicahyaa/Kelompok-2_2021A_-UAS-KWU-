...
<body>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="#" aria-expanded="false" class="active" style="background-color: #E7DAD4;"><i class="icon nalika-mail icon-wrap" style=" color: #000000;"></i> <span class="mini-click-non" style=" color: #000000;">Pesan</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li class="active" style="background-color: #E7DAD4;"><a title="Semua Pesan" href="semuapesan.php" ><span class="mini-sub-pro" style=" color: #000000;">Semua Pesan</span></a></li>
                            </ul>
                        </li>
    ...
    <div class="all-content-wrapper">
        ...
        <?php
        $que = $kon->kueri("SELECT * FROM kontak WHERE kontak_id = '$kontak'");
        $hasil = $kon->hasil_data($que);
        ?>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="p-m custom-address-mailbox">
                                                        <div class="p-xs h4">
                                                            <small class="pull-right">
                                                                <?php echo $hasil['kontak_tanggal'] ?>
                                                            </small>
                                                            <h2> Detail Pesan </h2>

                                                        </div>
                                                        <div>
                                                            <span class="font-extra-bold">Subjek: </span> <?php echo $hasil['kontak_subjek'] ?>
                                                        </div>
                                                        <div>
                                                            <span class="font-extra-bold">Dari: </span>
                                                            <a href="#"><?php echo $hasil['kontak_email'] ?></a>
                                                        </div>
                                                        <div>
                                                            <span class="font-extra-bold">Tanggal: </span> <?php echo $hasil['kontak_tanggal'] ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="panel-body panel-csm">
                                                    <div>
                                                        ...
                                                        <p><?php echo $hasil['kontak_pesan'] ?>
                                                            <br />
                                                        </p>

                                                        <p> <strong><?php echo $hasil['kontak_nama'] ?> </strong>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="panel-footer text-right">
                                                    <div class="btn-group">
                                                        <a href="pesan_proses.php?aksi=hapus&tid=<?=$hasil['kontak_id']?>"><button class="btn btn-danger"><i class="fa fa-trash-o"></i> Hapus</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
