                                ...
                                <div class="sparkline12-list">
                                    <div class="sparkline12-graph">
                                        <div class="basic-login-form-ad">
                                            <div class="row">
                                                <?php
                                                $que = $kon->kueri("SELECT * FROM pembeli WHERE pembeli_id = '$pembeli'");
                                                $hasil = $kon->hasil_data($que);
                                                ?>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div id="myTabContent1" class="tab-content">
                                                        <div class="product-tab-list tab-pane fade active in" style="max-width: 100%; width: 370px; height: 350px; display: flex; align-items: center; justify-content: center;">
                                                            <img src="../pembeli/<?php echo $hasil['pembeli_foto'] ?>" alt="Foto Users" style="width: 370px; height: 350px; border-radius:100%;" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-3 col-sm-6 col-xs-12">
                                                    <div class="single-product-details res-pro-tb">
                                                        <h2 style="margin-top: 50px;"><?php echo $hasil['pembeli_nama'] ?></h2>
                                                        <div class="single-pro-cn">
                                                            <h4 style="margin-top: 15px;">Username : <?php echo $hasil['pembeli_username'] ?></h4>
                                                            <h4 style="margin-top: 15px;">Email : <?php echo $hasil['pembeli_email'] ?></h4>
                                                            <h4 style="margin-top: 15px;">Jenis Kelamin : <?php echo $hasil['pembeli_gender'] ?></h4>
                                                            <h4 style="margin-top: 15px;">No.Hp : <?php echo $hasil['pembeli_hp'] ?></h4>
                                                            <h4 style="margin-top: 15px;">Alamat : <?php echo $hasil['pembeli_alamat'] ?></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
